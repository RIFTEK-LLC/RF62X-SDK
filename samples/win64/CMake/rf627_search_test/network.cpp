...
BOOL EnumAdapterAddresses()
{
    ...
    for (aa = adapter_addresses; aa != NULL; aa = aa->Next) {
        ...
        for (ua = aa->FirstUnicastAddress; ua != NULL; ua = ua->Next) {
            ...
            sprintf(_ifs[_ifs_cnt++], "%u.%u.%u.%u", (BYTE)(ua->Address.lpSockaddr->sa_data[2]), (BYTE)(ua->Address.lpSockaddr->sa_data[3]), (BYTE)(ua->Address.lpSockaddr->sa_data[4]), (BYTE)(ua->Address.lpSockaddr->sa_data[5]));
        }
    }
