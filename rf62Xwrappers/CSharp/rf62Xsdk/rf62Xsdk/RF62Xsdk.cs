...
namespace SDK
{
    namespace SCANNERS
    {
        public unsafe class RF62X
        {
            ...
            {
                [FieldOffset(0)]
                public SCANNERS_TYPES scanner_type;
                [FieldOffset(4)]
                public PROTOCOLS_TYPES protocol_type;
                [FieldOffset(8)]
            ...
            [DllImport("rf62Xcore.dll", CallingConvention = CallingConvention.Cdecl)]
            private static extern hello_information get_info_about_scanner(scanner_base_t* device, PROTOCOLS_TYPES protocol);
            ...
            [DllImport("rf62Xcore.dll", CallingConvention = CallingConvention.Cdecl)]
            private static extern rf627_profile2D_t* get_profile2D_from_scanner(scanner_base_t* device, bool zero_points, PROTOCOLS_TYPES protocol);
            [DllImport("rf62Xcore.dll", CallingConvention = CallingConvention.Cdecl)]
            private static extern rf627_profile2D_t* rf627_old_get_profile(rf627_old_t* scanner);
            [DllImport("rf62Xcore.dll", CallingConvention = CallingConvention.Cdecl)]
            ...
            {
                public Param(void* _base, dynamic Min, dynamic Max, uint MaxCount, uint DefCount, dynamic DefValue, List<ValuesEnum> ValuesEnum, dynamic Step, T Value)
                {
            ...
            public unsafe class Profile
            {
                public class Header
                {
                    ...
                    {
                        data_type = (PROFILE_TYPE)((rf627_profile2D_t*)_base)->rf627_profile2D->header.data_type;

                        data_offset = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.data_offset;
                        flags = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.flags;
                        device_type = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.device_type;
                        serial_number = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.serial_number;
                        system_time = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.system_time;

                        version_major = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.proto_version_major;
                        version_minor = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.proto_version_minor;
                        hardware_params_offset = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.hardware_params_offset;
                        data_offset = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.data_offset;
                        packet_count = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.packet_count;
                        measure_count = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.measure_count;

                        zmr = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.zmr;
                        xemr = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.xemr;
                        discrete_value = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.discrete_value;

                        exposure_time = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.exposure_time;
                        laser_value = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.laser_value;
                        step_count = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.step_count;
                        dir = ((rf627_profile2D_t*)_base)->rf627_profile2D->header.dir;
                    }
                        ...
                        case PROFILE_TYPE.PIXELS_INTERPOLATED:
                            {
                                ...
                                for (int i = 0;
                                    i < ((rf627_profile2D_t*)_base)->rf627_profile2D->pixelsFormat.pixels_count;
                                    i++)
                                {
                                    pixels.Add(((rf627_profile2D_t*)_base)->rf627_profile2D->pixelsFormat.pixels[i]);
                                }

                                if (((rf627_profile2D_t*)_base)->rf627_profile2D->intensity_count > 0)
                                {
                                    intensities = new List<byte>();
                                    for (int i = 0;
                                        i < ((rf627_profile2D_t*)_base)->rf627_profile2D->intensity_count;
                                        i++)
                                        intensities.Add(((rf627_profile2D_t*)_base)->rf627_profile2D->intensity[i]);
                                }
                                break;
                            }
                        ...
                        case PROFILE_TYPE.PROFILE_INTERPOLATED:
                            {
                                ...
                                for (int i = 0;
                                    i < ((rf627_profile2D_t*)_base)->rf627_profile2D->profileFormat.points_count;
                                    i++)
                                {
                                    Point2D point = new Point2D(
                                        ((rf627_profile2D_t*)_base)->rf627_profile2D->profileFormat.points[i].x,
                                        ((rf627_profile2D_t*)_base)->rf627_profile2D->profileFormat.points[i].z);
                                    points.Add(point);
                                }
            ...
            {
                public HelloInfo(void* info, PROTOCOLS_TYPES type)
                {
                    switch (type)
                    {
                        case PROTOCOLS_TYPES.SERVICE_PROTOKOL:
                            ...
                            break;
                        case PROTOCOLS_TYPES.ETHERNET_IP:
                            break;
                        case PROTOCOLS_TYPES.MODBUS_TCP:
                            break;
                        default:
                            break;
                    }
            ...
            public unsafe class RF627old
            {
                ...
                public HelloInfo GetInfo(PROTOCOLS_TYPES protocol = PROTOCOLS_TYPES.SERVICE_PROTOKOL)
                {
                    switch (protocol)
                    {
                        case PROTOCOLS_TYPES.SERVICE_PROTOKOL:
                            {
                                hello_information info = get_info_about_scanner(((scanner_base_t*)this._base), protocol);
                                return new HelloInfo((void*)info.rf627old_hello_info_service_protocol, protocol);
                            }
                            break;
                        case PROTOCOLS_TYPES.ETHERNET_IP:
                            {
                        ...
                        case PROTOCOLS_TYPES.MODBUS_TCP:
                            ...
                            break;
                        default:
                            HelloInfo hello_info = new HelloInfo(null, protocol);
                            return hello_info;
                            break;
                    }
                }
                        ...
                        case PROTOCOLS_TYPES.SERVICE_PROTOKOL:
                            {
                                ...
                                if (profile_from_scanner->rf627_profile2D != null)
                                {
                                    ...
                                    CORES.RF62X.Memory.Free(profile_from_scanner->rf627_profile2D->intensity);
                                    CORES.RF62X.Memory.Free(profile_from_scanner->rf627_profile2D->pixelsFormat.pixels);
                                    CORES.RF62X.Memory.Free(profile_from_scanner->rf627_profile2D);
                            ...
                            case "u32_arr_t":
                                {
                                    ...
                                    Param<List<uint>> result = new Param<List<uint>>(
                                       param,
                                       param->arr_uint->min,
                                       param->arr_uint->max,
