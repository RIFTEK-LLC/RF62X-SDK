...
namespace SDK
{
    namespace CORES
    {
        unsafe static class RF627core
        {
            ...
            public static void Init()
            {
                ...
                {
                    host_ip_addr = (uint)BitConverter.ToInt32((IPAddress.Parse("192.168.1.2").GetAddressBytes()), 0),
    ...
    namespace SCANNERS
    {
        public static unsafe class RF627
        {
            ...
            {
                return CORES.RF627core.CoreVersion();
            }
                        ...
                        case PROTOCOLS_TYPES.SERVICE_PROTOKOL:
                            {
                                ...
                                if (profile_from_scanner->rf627_profile != null)
                                {
                                    ...
                                    CORES.RF627core.Memory.Free(profile_from_scanner->rf627_profile->intensity);
                                    CORES.RF627core.Memory.Free(profile_from_scanner->rf627_profile->pixelsFormat.pixels);
                                    CORES.RF627core.Memory.Free(profile_from_scanner->rf627_profile);
                                    CORES.RF627core.Memory.Free(profile_from_scanner);
                                    return profile;
                                }
                                CORES.RF627core.Memory.Free(profile_from_scanner);
                                break;
